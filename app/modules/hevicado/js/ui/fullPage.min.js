...
function ka(a){var d="all "+c.scrollingSpeed+"ms "+c.easingcss3;a.removeClass("fp-notransition");return a.css({"-webkit-transition":d,transition:d})}function S(a){return a.addClass("fp-notransition")}function Fa(a,d){if(825>a||900>d){var c=Math.min(100*a/825,100*d/900).toFixed(2);b("#wrapper-page").css("font-size",c+"%")}else b("#wrapper-page").css("font-size","100%")}function L(a,d){c.menu&&(b(c.menu).find(".active").removeClass("active"),b(c.menu).find('[data-menuanchor="'+a+'"]').addClass("active"));c.navigation&&
...
a.replace("/","-").replace("#","");b("#wrapper-page")[0].className=b("#wrapper-page")[0].className.replace(/\b\s?fp-viewing-[^\s]+\b/g,"");b("#wrapper-page").addClass("fp-viewing-"+a)}function Ha(){var a=document.createElement("p"),b,c={webkitTransform:"-webkit-transform",OTransform:"-o-transform",msTransform:"-ms-transform",MozTransform:"-moz-transform",transform:"transform"};document.body.insertBefore(a,null);for(var g in c)void 0!==a.style[g]&&(a.style[g]="translate3d(1px,1px,1px)",b=window.getComputedStyle(a).getPropertyValue(c[g]));
...
b,c,g,f){return g*(b/=f)*b*b*b+c}});b.fn.fullpage.setAutoScrolling=function(a,d){U("autoScrolling",a,d);var e=b(".fp-section.active");c.autoScrolling&&!c.scrollBar?(b("html, #wrapper-page").css({overflow:"hidden",height:"100%"}),b.fn.fullpage.setRecordHistory(c.recordHistory,"internal"),f.css({"-ms-touch-action":"none","touch-action":"none"}),e.length&&m(e.position().top)):(b("html, #wrapper-page").css({overflow:"visible",height:"initial"}),b.fn.fullpage.setRecordHistory(!1,"internal"),f.css({"-ms-touch-action":"",
"touch-action":""}),m(0),b("html, #wrapper-page").scrollTop(e.position().top))};b.fn.fullpage.setRecordHistory=function(a,b){U("recordHistory",a,b)};b.fn.fullpage.setScrollingSpeed=function(a,b){U("scrollingSpeed",a,b)};b.fn.fullpage.setMouseWheelScrolling=function(a){a?document.addEventListener?(document.addEventListener("mousewheel",r,!1),document.addEventListener("wheel",r,!1)):document.attachEvent("onmousewheel",r):document.addEventListener?(document.removeEventListener("mousewheel",r,!1),document.removeEventListener("wheel",
...
(0!==b(".fp-section.active").index(".fp-section")||0===b(".fp-section.active").index(".fp-section")&&0!==a.index())&&N(a);c.fixedElements&&c.css3&&b(c.fixedElements).appendTo("#wrapper-page");c.navigation&&(h.css("margin-top","-"+h.height()/2+"px"),h.find("li").eq(b(".fp-section.active").index(".fp-section")).find("a").addClass("active"));c.menu&&c.css3&&b(c.menu).closest(".fullpage-wrapper").length&&b(c.menu).appendTo("#wrapper-page");c.scrollOverflow?("complete"===document.readyState&&V(),b(window).on("load",V)):
b.isFunction(c.afterRender)&&c.afterRender.call(f);na();a=window.location.hash.replace("#","").split("/")[0];if(a.length){var d=b('[data-anchor="'+a+'"]');!c.animateAnchor&&d.length&&(c.autoScrolling?m(d.position().top):(m(0),H(a),b("html, #wrapper-page").scrollTop(d.position().top)),L(a,null),b.isFunction(c.afterLoad)&&c.afterLoad.call(d,a,d.index(".fp-section")+1),d.addClass("active").siblings().removeClass("active"))}b(window).on("load",function(){var a=window.location.hash.replace("#","").split("/"),b=
