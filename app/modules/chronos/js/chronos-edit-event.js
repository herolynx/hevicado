 ...
 */
chronosEditEvent.controller('EditEventCtrl',
    ['$scope', '$log', '$state', '$stateParams', '$q', 'Session', 'CalendarService', 'EventActionManager', 'EventUtils', 'CALENDAR_EVENTS', 'UsersService', 'UserUtils', 'uiNotification', '$filter',
        function ($scope, $log, $state, $stateParams, $q, Session, CalendarService, EventActionManager, EventUtils, CALENDAR_EVENTS, UsersService, UserUtils, uiNotification, $filter) {
 ...
 * @param uiNotification notification manager
 */
chronosEditEvent.controller('DisplayEventCtrl',
