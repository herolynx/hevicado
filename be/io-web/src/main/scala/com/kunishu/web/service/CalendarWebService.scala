 ...
 */
class CalendarWebService(requestContext: RequestContext) extends Actor with ActorLogging with HealthCheckWebService {


  override def receive = LoggingReceive {

    healthCheck(calendarService, requestContext) orElse {
