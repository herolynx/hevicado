  ...
  render: function() {
    return (
      <section id="navigation">
        ...
        <nav>
          <ul>
            <li><a href="search.html"><i className="fa fa-search"></i> Szukaj</a></li>
            ...
            <li className="active"><a href="my_accout.html"><i className="fa fa-cogs"></i>Moje konto</a></li>
        ...
        <div className="footer">
          {this.props.navigation.poweredBy} <a href="http://www.herolynx.com" target="_blank">HeroLynx.com</a>
        </div>
      </section>
    );
  }
