          ...
          <ul>
            ...
            <li>
              <a href="dashboard.html">
                <i className="fa fa-area-chart"></i>Pulpit</a>
            </li>
            <li>
              <a href="calendar_30days.html">
                <i className="fa fa-calendar"></i>Kalnedarz</a>
            </li>
            <li>
              <a href="#">
                <i className="fa fa-folder-open-o"></i>Karta Pacjenta</a>
            </li>
            <li>
              <a href="visit.html">
                <i className="fa fa-folder-open-o"></i>Moje wizyty</a>
            </li>
            <li>
              <a href="cabinet_list.html">
                <i className="fa fa-hospital-o"></i>Gabinet</a>
            </li>
            <li>
              <a href="message.html">
                <i className="fa fa-inbox"></i>Wiadomości</a>
            </li>
            <li className="active">
              <a href="my_accout.html">
                <i className="fa fa-cogs"></i>Moje konto</a>
            </li>
            <li>
              <a href="statistic.html">
                <i className="fa fa-bar-chart"></i>Statystyki</a>
            </li>
            <li>
              <a href="#">
                <i className="fa fa-sign-out"></i>Wyloguj</a>
            </li>
          </ul>
        </nav>
